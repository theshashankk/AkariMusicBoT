...
async def play(client: Client, message_: Message):
    ...
    if message_.chat.id in tgcalls.pytgcalls.active_calls:
        ...
        chat_id=message_.chat.id,
        photo="https://telegra.ph/file/8587b46ede513c5cf82c0.jpg",
        caption=f"Playing Your song Via  [Akari Music BoT](https://t.me/akari_Support).",
         ) 
...
async def deezer(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        chat_id=message_.chat.id,
        photo="final.png",
        caption=f"Playing [{title}]({url}) Via [Deezer](https://t.me/akari_support)."
    ) 
    os.remove("final.png")
# -----------------------------------------------------Jiosaavn-----------------------------------------------------------------
@Client.on_message(
...
async def jiosaavn(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        chat_id=message_.chat.id,
        caption=f"Playing {sname} Via [jio savan](https://t.me/akari_support)",
        photo="final.png",
    )
    os.remove("final.png")
...
async def ytp(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        chat_id=message_.chat.id,
        caption=f"Playing `{query}` Via [YouTube](https://t.me/akari_support)",
        photo="final.png",
...
async def generate_cover_square(requested_by, title, artist, duration, thumbnail):
    ...
    image2 = Image.open("Others/akari.jpg")
